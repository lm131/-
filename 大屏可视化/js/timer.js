...
var b=["星期天","星期一","星期二","星期三","星期四","星期五","星期六"];
...
function showTime()
{
	...
	document.getElementById("J_date").getElementsByTagName("span")[0].innerHTML=str;
	document.getElementById("J_date").getElementsByTagName("span")[1].innerHTML=b[time.getDay()];
